...
import { FaArrowLeft, FaArrowRight, FaScroll } from "react-icons/fa";
    ...
    <PageTransition>
      <Page darkMode={true}>
        ...
        <BackgroundInfo>
          ...
          <InfoText>
            Your background represents your character&apos;s origin story—their
            life before becoming an adventurer. It grants specific skill
            proficiencies, equipment, and special features that reflect your
            past experiences.
          </InfoText>
          ...
          <InfoList>
            <InfoListItem>
              <strong>Skills & Proficiencies:</strong> Each background provides
              proficiency in two skills and sometimes tools or languages.
            </InfoListItem>
            <InfoListItem>
              <strong>Starting Equipment:</strong> Backgrounds determine some of
              the gear you begin your adventure with.
            </InfoListItem>
            <InfoListItem>
            ...
            <InfoListItem>
              <strong>Special Feature:</strong> Each background grants a unique
              feature that provides story and roleplaying opportunities.
            </InfoListItem>
          </InfoList>
        </BackgroundInfo>
