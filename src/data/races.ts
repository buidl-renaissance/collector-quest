...
export const expandedRaces: Race[] = [
    ...
    { id: "air-genasi", name: 'Genasi (Air)', source: "Monsters of the Multiverse", description: "Beings infused with elemental air energy, light and swift.", accessory: "Elemental orb (fire, water, etc.), tattooed scroll" },
    { id: "earth-genasi", name: 'Genasi (Earth)', source: "Monsters of the Multiverse", description: "Beings infused with elemental earth energy, strong and resilient.", accessory: "Elemental orb (fire, water, etc.), tattooed scroll" },
    { id: "fire-genasi", name: 'Genasi (Fire)', source: "Monsters of the Multiverse", description: "Beings infused with elemental fire energy, passionate and quick-tempered.", accessory: "Elemental orb (fire, water, etc.), tattooed scroll" },
    { id: "water-genasi", name: 'Genasi (Water)', source: "Monsters of the Multiverse", description: "Beings infused with elemental water energy, adaptable and fluid.", accessory: "Elemental orb (fire, water, etc.), tattooed scroll" },
